...
void QuadraticProbing::Delete(vector<int>&HTable,int tsize){
    int x;
...
void QuadraticProbing::Searching(vector<int>HTable,int tsize){
       int x;
...
void QuadraticProbing::Insert(vector<int> &HTable,int tsize){
    int x;
...
void QuadraticProbing::Display(vector<int>HTable,int tsize){
