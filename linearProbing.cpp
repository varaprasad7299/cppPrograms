...
void LinearProbing::Delete(vector<int>&HTable,int tsize){
   int x;
...
void LinearProbing::Searching(vector<int>HTable,int tsize){
       int x;
...
void LinearProbing::Insert(vector<int> &HTable,int tsize){
    int x;
...
void LinearProbing::Display(vector<int>HTable,int tsize){
